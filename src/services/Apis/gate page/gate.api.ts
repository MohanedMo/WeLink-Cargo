...
import type {
  BookTicketBodyVisitor,
  BookTicketBodySubscriber,
  Gate,
} from "./gate.types";
...
export async function getZonesByGate(
...
export async function bookTicket(
  body: BookTicketBodyVisitor | BookTicketBodySubscriber
) {
