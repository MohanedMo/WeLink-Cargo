...
import { CheckCircle, Printer, MapPin, Clock, CreditCard, X } from "lucide-react"
...
export function TicketModel({ isOpen, onClose, ticketData }: SuccessModalProps) {
        ...
        <div className="p-6">
          <div className="relative">
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-bold text-green-400 mb-1">Access Granted!</h2>
              <p className="text-sm text-gray-400">Your parking spot has been reserved</p>
            </div>
            ...
            <div className="mb-6">
              <div className="relative h-20 bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                ...
                <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2">
                  ...
                  >
                    {animationComplete ? "OPEN" : showGateAnimation ? "OPENING..." : "CLOSED"}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-700 bg-gray-800/60 rounded-lg print:bg-white print:text-black print:border-black">
              <div className="p-4">
                <div className="text-center mb-4 print:mb-6">
                  <h3 className="font-bold text-lg text-gray-100 print:text-black">PARKING TICKET</h3>
                  <p className="text-xs text-gray-400 print:text-gray-600">Keep this ticket for your records</p>
                </div>

                <div className="space-y-3 print:space-y-4">
                  <div className="flex items-center justify-between py-2 border-b border-gray-700 print:border-gray-300">
                    <span className="text-sm text-gray-400 print:text-gray-600">Ticket ID:</span>
                    <span className="font-mono font-bold text-gray-100 print:text-black">{ticketData.ticket.id}</span>
                  </div>

                  <div className="flex items-center justify-between py-2 border-b border-gray-700 print:border-gray-300">
                    <div className="flex items-center gap-2">
                      <Clock className="h-4 w-4 text-gray-400 print:text-gray-600" />
                      <span className="text-sm text-gray-400 print:text-gray-600">Check-in:</span>
                    </div>
                    <span className="font-mono text-gray-100 print:text-black">{ticketData.ticket.checkinAt}</span>
                  </div>

                  <div className="flex items-center justify-between py-2 border-b border-gray-700 print:border-gray-300">
                    <div className="flex items-center gap-2">
                      <MapPin className="h-4 w-4 text-gray-400 print:text-gray-600" />
                      <span className="text-sm text-gray-400 print:text-gray-600">Zone:</span>
                    </div>
                    <span className="font-bold text-gray-100 print:text-black">{ticketData.zoneState.name}</span>
                  </div>

                  <div className="flex items-center justify-between py-2 border-b border-gray-700 print:border-gray-300">
                    <span className="text-sm text-gray-400 print:text-gray-600">Gate:</span>
                    <span className="font-mono text-gray-100 print:text-black">{ticketData.ticket.gateId.toUpperCase()}</span>
                  </div>

                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-2">
                      <CreditCard className="h-4 w-4 text-gray-400 print:text-gray-600" />
                      <span className="text-sm text-gray-400 print:text-gray-600">Rate:</span>
                    </div>
                    <div className="text-right">
                      <span className="font-bold text-gray-100 print:text-black">${ticketData.zoneState.rateSpecial}/hr</span>
